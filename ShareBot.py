        ...
        try:
            if req.json()["status_code"] == 0:
                ...
                if DebugMode:
                    ...
                    print(Colorate.Horizontal(Colors.green_to_white, f"Gesendete Shares: {TotalSendedShare} ({impr_id})"))
...
if __name__ == "__main__":
    ...
    if Title("Proxy Scraper by Jonas Sch"):
        Debug = Write.Input("Debug Fehlgeschlagen [y/n] ? > ", Colors.red_to_blue, interval=0.0001)
